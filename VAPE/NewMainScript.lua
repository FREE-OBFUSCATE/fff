...
local customdir = (shared.VapePrivate and "BxB_Bedwar_private/" or "BxB_Bedwar/")
...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		if not betterisfile("BxB_Bedwar/"..scripturl) then
			error("File not found : BxB_Bedwar/"..scripturl)
		end
		return readfile("BxB_Bedwar/"..scripturl)
	else
		local res
		...
		res = game:HttpGet("https://raw.githubusercontent.com/FREE-OBFUSCATE/fff/main/VAPE/"..scripturl, true)
...
if not (getasset and requestfunc and queueteleport) then
	print("BxB_Bedwar not supported with your exploit.")
	return
end

if shared.VapeExecuted then
	error("BxB_Bedwar Already Injected")
	return
else
...
if isfolder("BxB_Bedwar") == false then
	makefolder("BxB_Bedwar")
end
if not betterisfile("BxB_Bedwar/assetsversion.dat") then
	writefile("BxB_Bedwar/assetsversion.dat", "1")
end
...
if not betterisfile("BxB_Bedwar/language.dat") then
	writefile("BxB_Bedwar/language.dat", "en-us")
end
if isfolder("BxB_Bedwar/assets") == false then
	makefolder("BxB_Bedwar/assets")
end
task.spawn(function()
	local assetver = checkassetversion()
	if assetver and assetver > readfile("BxB_Bedwar/assetsversion.dat") then
		redownload = true
		if isfolder("BxB_Bedwar/assets") and shared.VapeDeveloper == nil then
			if delfolder then
				delfolder("BxB_Bedwar/assets")
				makefolder("BxB_Bedwar/assets")
			end
		end
		writefile("BxB_Bedwar/assetsversion.dat", assetver)
	end
end)
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/FREE-OBFUSCATE/fff/main/VAPE/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/FREE-OBFUSCATE/fff/main/VAPE/"..path:gsub("BxB_Bedwar/assets", "assets"),
			Method = "GET"
		})
...
task.spawn(function()
	...
	image.Image = getcustomassetfunc("BxB_Bedwar/assets/CombatIcon.png")
	...
	task.delay(15, function()
		if image.ContentImageSize == Vector2.new(0, 0) and (not shown) and (not redownload) and (not betterisfile("BxB_Bedwar/assets/check3.txt")) then 
			shown = true
			local ErrorPrompt = getrenv().require(game:GetService("CoreGui").RobloxGui.Modules.ErrorPrompt)
			local prompt = ErrorPrompt.new("Default")
			prompt._hideErrorCode = true
			local gui = Instance.new("ScreenGui", game:GetService("CoreGui"))
			prompt:setParent(gui)
			prompt:setErrorTitle("BxB_Bedwar")
			prompt:updateButtons({{
				Text = "OK",
				Callback = function() 
					prompt:_close() 
					writefile("BxB_Bedwar/assets/check3.txt", "")
				end,
				Primary = true
			}}, 'Default')
			prompt:_open("BxB_Bedwar has detected that you have a skill issue and cannot load assets, Consider getting a better executor.")
		end
	end)
end)
...
local Combat = GuiLibrary.CreateWindow({
	["Name"] = "Combat", 
	["Icon"] = "BxB_Bedwar/assets/CombatIcon.png", 
	["IconSize"] = 15
})
local Blatant = GuiLibrary.CreateWindow({
	["Name"] = "Blatant", 
	["Icon"] = "BxB_Bedwar/assets/BlatantIcon.png", 
	["IconSize"] = 16
})
local Render = GuiLibrary.CreateWindow({
	["Name"] = "Render", 
	["Icon"] = "BxB_Bedwar/assets/RenderIcon.png", 
	["IconSize"] = 17
})
local Utility = GuiLibrary.CreateWindow({
	["Name"] = "Utility", 
	["Icon"] = "BxB_Bedwar/assets/UtilityIcon.png", 
	["IconSize"] = 17
})
local World = GuiLibrary.CreateWindow({
	["Name"] = "World", 
	["Icon"] = "BxB_Bedwar/assets/WorldIcon.png", 
	["IconSize"] = 16
})
local Friends = GuiLibrary.CreateWindow2({
	["Name"] = "Friends", 
	["Icon"] = "BxB_Bedwar/assets/FriendsIcon.png", 
	["IconSize"] = 17
})
local Profiles = GuiLibrary.CreateWindow2({
	["Name"] = "Profiles", 
	["Icon"] = "BxB_Bedwar/assets/ProfilesIcon.png", 
	["IconSize"] = 19
})
GUI.CreateDivider()
GUI.CreateButton({
...
ProfilesTextList = Profiles.CreateTextList({
	...
	["RemoveFunction"] = function(num, obj) 
		if obj ~= "default" and obj ~= GuiLibrary["CurrentProfile"] then 
			pcall(function() delfile(customdir.."Profiles/"..obj..(shared.CustomSaveVape or game.PlaceId)..".BxBprofile.txt") end)
	...
	["CustomFunction"] = function(obj, profilename) 
		...
		bindimg.Image = getcustomassetfunc("BxB_Bedwar/assets/KeybindIcon.png")
		...
		bindbkg.MouseEnter:Connect(function() 
			bindimg.Image = getcustomassetfunc("BxB_Bedwar/assets/PencilIcon.png") 
			bindimg.Visible = true
			bindtext.Visible = false
			bindbkg.Size = UDim2.new(0, 20, 0, 21)
			bindbkg.Position = UDim2.new(1, -50, 0, 6)
...
OnlineProfilesButtonImage.Image = getcustomassetfunc("BxB_Bedwar/assets/OnlineProfilesButton.png")
...
OnlineProfilesExitButton.Image = getcustomassetfunc("BxB_Bedwar/assets/ExitIcon1.png")
...
OnlineProfilesFrameShadow.Image = getcustomassetfunc("BxB_Bedwar/assets/WindowBlur.png")
...
OnlineProfilesFrameIcon.Image = getcustomassetfunc("BxB_Bedwar/assets/ProfilesIcon.png")
...
OnlineProfilesButton.MouseButton1Click:Connect(function()
	...
	if profilesloaded == false then
		...
		for i,v in pairs(grabdata("https://raw.githubusercontent.com/BxB-xyz/BxB-Hub-PremiumScript/main/BxB-Script/BedWars/VAPE/VapeProfile/Profiles//"..saveplaceid.."/profilelist.txt")) do 
			onlineprofiles[i] = v
		end
		for i2,v2 in pairs(onlineprofiles) do
			local profileurl = "https://raw.githubusercontent.com/BxB-xyz/BxB-Hub-PremiumScript/main/BxB-Script/BedWars/VAPE/VapeProfile/Profiles/"..saveplaceid.."/"..v2.OnlineProfileName
			...
			profiledownload.MouseButton1Click:Connect(function()
				writefile(customdir.."Profiles/"..v2["ProfileName"]..saveplaceid..".BxBprofile.txt", game:HttpGet(profileurl, true))
...
local TextGui = GuiLibrary.CreateCustomWindow({
	["Name"] = "Text GUI", 
	["Icon"] = "BxB_Bedwar/assets/TextGUIIcon1.png", 
	["IconSize"] = 21
})
local TextGuiCircleObject = {["CircleList"] = {}}
GUI.CreateCustomToggle({
	["Name"] = "Text GUI", 
	["Icon"] = "BxB_Bedwar/assets/TextGUIIcon3.png",
...
onething.Image = getcustomassetfunc(translatedlogo and "BxB_Bedwar/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "BxB_Bedwar/assets/VapeLogo3.png")
...
onething2.Image = getcustomassetfunc("BxB_Bedwar/assets/VapeLogo4.png")
...
textguimode = TextGui.CreateDropdown({
	...
	["Function"] = function(val)
		...
		if val == "Drawing" then
			...
			onethingdrawing.Data = readfile(translatedlogo and "BxB_Bedwar/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "BxB_Bedwar/assets/VapeLogo3.png")
			...
			onething2drawing.Data = readfile("BxB_Bedwar/assets/VapeLogo4.png")
			...
			onething3drawing.Data = readfile(translatedlogo and "BxB_Bedwar/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "BxB_Bedwar/assets/VapeLogo3.png")
			...
			onething4drawing.Data = readfile("BxB_Bedwar/assets/VapeLogo4.png")
...
TextGui.CreateToggle({
	...
	["HoverText"] = "Renders a BxB_Bedwar watermark"
})
...
local TargetInfo = GuiLibrary.CreateCustomWindow({
	["Name"] = "Target Info",
	["Icon"] = "BxB_Bedwar/assets/TargetInfoIcon1.png",
	["IconSize"] = 16
})
...
healthbarbkgshadow.Image = getcustomassetfunc("BxB_Bedwar/assets/WindowBlur.png")
...
GUI.CreateCustomToggle({
	["Name"] = "Target Info", 
	["Icon"] = "BxB_Bedwar/assets/TargetInfoIcon2.png", 
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if (not teleported) and (not shared.VapeIndependent) then
		teleported = true
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("BxB_Bedwar/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-xyz/BxB-Hub-PremiumScript/main/BxB-Script/BedWars/VAPE/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
...
if shared.VapeIndependent then
	spawn(function()
		...
		if not shared.VapeSwitchServers then
			if blatantmode["Enabled"] then
				pcall(function()
					local frame = GuiLibrary["CreateNotification"]("Blatant Enabled", "BxB.xyz is now in Blatant Mode.", 5.5, "assets/WarningNotification.png")
	...
	if betterisfile("BxB_Bedwar/CustomModules/"..game.PlaceId..".lua") then
		loadstring(readfile("BxB_Bedwar/CustomModules/"..game.PlaceId..".lua"))()
	else
	...
	if shared.VapePrivate then
		if pcall(function() readfile("BxB_Bedwar_private/CustomModules/"..game.PlaceId..".lua") end) then
			loadstring(readfile("BxB_Bedwar_private/CustomModules/"..game.PlaceId..".lua"))()
		end	
	end
	GuiLibrary["LoadSettings"](shared.VapeCustomProfile)
	local profiles = {}
